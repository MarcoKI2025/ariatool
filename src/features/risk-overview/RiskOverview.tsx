...
export function RiskOverview() {
  ...
  return (
    <div>
      <div className="mb-6">
        <div className="label-xs mb-1.5">Step 2 of 8 · Core Analysis</div>
      ...
      <div className="flex items-center justify-between pt-5 border-t border-border mt-7">
        ...
        <span className="text-[10px] text-muted-foreground italic">Step 2 of 8 · Risk overview & governance signals</span>
        <button onClick={() => setActiveStep(3)} className="view-nav-next">Insurance Decision →</button>
      </div>
    </div>
  );
}
